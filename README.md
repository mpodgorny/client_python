...
# Defining host is optional and default to http://api.mathjs.org/v4
configuration.host = "http://api.mathjs.org/v4"
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**root_get**](docs/DefaultApi.md#root_get) | **GET** / | Evaluating math.
